package com.manriquetavi.stores.editModule
...
import com.manriquetavi.stores.databinding.FragmentEditStoreBinding
import com.manriquetavi.stores.editModule.viewModel.EditStoreViewModel
import com.manriquetavi.stores.mainModule.MainActivity
...
class EditStoreFragment : Fragment() {
    ...
    private fun validateFields(vararg textFields: TextInputLayout): Boolean{
        ...
        if(!isValid) Snackbar.make(mBinding.root, R.string.edit_store_message_invalid, Snackbar.LENGTH_SHORT).show()
